...
function cmb_scripts( $hook ) {
  	if ( $hook == 'post.php' || $hook == 'post-new.php' || $hook == 'page-new.php' || $hook == 'page.php' ) {
		wp_register_script( 'cmb-timepicker', plugins_url('/js/jquery.timePicker.min.js', __FILE__ ));
		wp_register_script( 'cmb-scripts', plugins_url('/js/cmb.js', __FILE__), array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'media-upload', 'thickbox', 'farbtastic' ) );
		wp_enqueue_script( 'cmb-timepicker' );
		wp_enqueue_script( 'cmb-scripts' );
		wp_register_style( 'cmb-styles', plugins_url('/style.css', __FILE__), array( 'thickbox', 'farbtastic' ) );
